...
2. Delete everthing in "ieee_event_frontend" folder except "node_modules" it is important to run app.<br>

3. Download this repo and paste all code to "ieee_event_frontend".<br>
