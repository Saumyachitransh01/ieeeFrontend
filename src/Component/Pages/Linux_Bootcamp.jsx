...
import Linux from "../Images/linux2.jpg";
    ...
    return (
        <div>
            <div className="col-md-12"><center>
                ...
                <div className="a">
                    <img src={Linux} alt="" class="img-fluid" width="660" height="345" />
                </div></center>
                <br />
                <p>Description:Linux is a family of open source Unix-like operating systems based on the Linux kernel, an operating system kernel first released on September 17, 1991, by Linus Torvalds. Linux is typically packaged in a Linux distribution.Linux
                        is versatile so you can use Linux on virtually anything you develop.Linux is a community where you can work with other Linux developers to share knowledge and learnings.</p>
                    ...
                    <ul>
                        ...
                        <li>Overview of bash scripting language & Linux file management</li>
                    </ul>
                    <p>The hands on session will help the participants to realize the practical aspects of Linux Operaring System.</p>
                    <h3>Eligibility:</h3>
                    ...
                    <ul>
                        ...
                        <li>No Certificate Will Be Provided To Those How Leave The Workshop In Between.</li>
                    </ul>
                    <h3>Note:</h3>
                    <ul>
